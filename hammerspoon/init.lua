...
hs.hotkey.bind(hyper, "g", launchOrCycleFocus("/Applications/Google Chrome Canary.app/"))
hs.hotkey.bind(hyper, "i", launchOrCycleFocus("Airmail"))
hs.hotkey.bind(hyper, "n", launchOrCycleFocus("Spotify"))
hs.hotkey.bind(hyper, "o", launchOrCycleFocus("/Users/andrew/Applications/Chrome Apps.localized/YouTube Music.app"))

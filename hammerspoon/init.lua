...
hs.hotkey.bind(hyper, "c", launchOrCycleFocus("com.hnc.Discord"))
...
hs.hotkey.bind(hyper, "r", launchOrCycleFocus("com.brave.Browser"))
...
hs.hotkey.bind(hyper, "i", launchOrCycleFocus("com.operasoftware.Opera"))
hs.hotkey.bind(hyper, "n", launchOrCycleFocus("com.spotify.client"))
hs.hotkey.bind(hyper, "o", launchOrCycleFocus("com.readdle.smartemail-Mac"))
